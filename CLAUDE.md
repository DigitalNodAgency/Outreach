...
### ICP Configuration (v17 — strict digital/social agencies)
...
> in-house PR hire (white-label PR fit). Size/revenue currently governed by the live
> repo var (Rizan's call: follow live variables); tighten via repo var, no code change.
```
